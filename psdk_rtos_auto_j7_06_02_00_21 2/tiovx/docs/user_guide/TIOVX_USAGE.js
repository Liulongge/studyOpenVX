...
[
    [ "TIOVX Usage Recommendations", "TIOVX_USAGE_REC.html", [
      ...
      [ "Pipelining Usage Recommendations", "TIOVX_USAGE_REC.html#TIOVX_USAGE_REC_PIPELINING", [
        [ "Node and Graph Parameter Definitions", "TIOVX_USAGE_REC.html#NODE_GRAPH_PARAMETER_DEFINITION", null ],
        [ "TI Pipelining Extension API's", "TIOVX_USAGE_REC.html#TI_PIPELINING_EXTENSION_APIS", null ],
        [ "Graph Parameter Considerations", "TIOVX_USAGE_REC.html#TI_PIPELINING_GRAPH_PARAMETER_SETUP", null ],
        [ "Pipelining Graph Construction Considerations for Composite Objects", "TIOVX_USAGE_REC.html#TI_PIPELINING_COMPOSITE_OBJECTS", null ]
      ] ]
    ] ],
    [ "OpenVX Standard Specification Interpretations", "TIOVX_SPEC_INTERPRETATIONS.html", [
      ...
      [ "Additional specification interpretation beyond the scope of OpenVX 1.1 Specification:", "TIOVX_SPEC_INTERPRETATIONS.html#TIOVX_SPEC_INTERPRETATIONS_BEYOND_OVX1_1_SPEC", null ],
    ...
    [ "Adding Custom Kernels", "TIOVX_TARGET_KERNEL.html", [
    ...
    [ "Debug Tools for TIOVX", "TIOVX_DEBUG.html", [
      [ "How to enable debug print statements", "TIOVX_DEBUG.html#DEBUG_PRINT", null ],
      [ "How to use the graph JPEG generation tool", "TIOVX_DEBUG.html#JPEG_TOOL", null ]
    ] ]
];